...
ActiveRecord::Schema.define(version: 2020_07_26_233112) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "client_gallery_statuses", id: :serial, force: :cascade do |t|
    t.integer "client_id"
  ...
  create_table "previews", id: :serial, force: :cascade do |t|
    t.integer "ticket_id"
    t.integer "client_id"
  end
